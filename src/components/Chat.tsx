...
[STATS_UPDATE:{"name":"Имя персонажа","race":"Раса","class":"Класс","level":1,"hp":{"current":10,"max":10},"xp":0,"stats":{"strength":10,"dexterity":10,"constitution":10,"intelligence":10,"wisdom":10,"charisma":10},"background":"Краткая история","equipment":["Предмет 1"],"story_summary":"КРАТКАЯ СВОДКА ВСЕГО ПУТЕШЕСТВИЯ"}]

ВАЖНО:
- Поле "name" в JSON ДОЛЖНО точно совпадать с именем игрока, который отправил последнее сообщение.
- Этот блок будет вырезан системой и использован для обновления интерфейса.
- НИКОГДА не пиши этот блок в коде (не используй обратные кавычки) - используй ТОЛЬКО формат [STATS_UPDATE:{...}].
...
- ОБЯЗАТЕЛЬНО выводи полный JSON со всеми полями (включая story_summary), ничего не пропускай!
