      ...
      >
        {messages.length === 0 && !isLoading ? (
          ...
          <div className="flex flex-col flex-grow min-h-0">
            ...
            {isAIGenerating && (
              <div className="w-full max-w-4xl mx-auto px-4 py-8 flex flex-col items-center justify-center gap-4 text-primary/70 animate-pulse">
                <Loader2 className="w-12 h-12 animate-spin" />
                <span className="text-xl font-mono uppercase tracking-[0.3em]">Мастер плетет историю...</span>
              </div>
            )}
          </div>
        )}
